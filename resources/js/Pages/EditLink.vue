      ...
      <div class="w-full max-w-3xl">
        ...
        >
          ...
          <div class="mb-4">
            ...
            />
            <label class="text-gray-400" for="open_in_new_tab">
              open in new tab currently set to -
              <span
                class="font-bold text-green-500"
                v-if="formData.open_in_new_tab"
                >yes</span
              ><span class="font-bold text-red-500" v-else>no</span> </label
            ><br />
          </div>
  ...
  data() {
    return {
      formData: {
        ...
        link: this.item.link,
        open_in_new_tab: this.item.open_in_new_tab,
      },
    };
  },
  methods: {
    updateLink() {
      this.$inertia.put("/link", this.formData);
    },
  },
};
</script>
