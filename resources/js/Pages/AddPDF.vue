      ...
      <div class="flex justify-center">
        <div class="w-full max-w-3xl">
          ...
          <form
            ...
            class="bg-white shadow-md rounded-md px-8 pt-6 pb-8 mb-4 my-8"
          >
            <div class="mb-4">
              <input
                class="
            ...
            <div v-if="progressText" class="text-center">
              <p class="text-gray-400 text-center" id="loaded_n_total">
                {{ progressText }}
              </p>
              <progress
                ref="progressBar"
